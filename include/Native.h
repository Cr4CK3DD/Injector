...
typedef PVOID(NTAPI* RTLALLOCATEHEAP)(PVOID, ULONG, ULONG);
typedef PVOID(NTAPI* RTLREALLOCATEHEAP)(PVOID, ULONG, PVOID, ULONG);
typedef BOOLEAN(NTAPI* RTLFREEHEAP)(PVOID, ULONG, PVOID);
...
typedef NTSTATUS(NTAPI* NTPROTECTVIRTUALMEMORY)(HANDLE, PVOID*, PULONG, ULONG, PULONG);
typedef NTSTATUS(NTAPI* NTFREEVIRTUALMEMORY)(HANDLE, PVOID*, PSIZE_T, ULONG);
typedef NTSTATUS(NTAPI* NTCREATETHREADEX)(PHANDLE, ACCESS_MASK, PVOID, HANDLE, PVOID, PVOID, ULONG, SIZE_T, SIZE_T, SIZE_T, PVOID);
...
typedef NTSTATUS(NTAPI* NTCREATESECTION)(PHANDLE, ULONG, POBJECT_ATTRIBUTES, PLARGE_INTEGER, ULONG, ULONG, HANDLE);
